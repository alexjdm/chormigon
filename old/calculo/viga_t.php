...
<html>
	...
	<?php
		...
		$_SESSION['d']=$_POST["h"]-$_POST["r"];
		$_SESSION['dr']=$_POST["r"];
		$_SESSION['hf']=$_POST["hf"];
		$_SESSION['fc']=$_POST["fc"];
		$_SESSION['fy']=$_POST["fy"];
		$_SESSION['Es']=$_POST["Es"];
		$_SESSION['Mu']=$_POST["Mu"];
		$_SESSION['Vu']=$_POST["Vu"];
		
		$_SESSION['ConSinR']=$_POST["Refuerzos"];
		$_SESSION['ConSinDS']=$_POST["optionsRadios"];
		...
		//DISEÑO PARA VIGAS CON ARMADURA SIMPLE
		if($arm=='simple'){
			$Asc=0;
			$a=$hf;
			$et=0.003*(($B1*$d)-$a)/$a;
